...
# Indexing only Question Titles for simplicity
# Define the index


#Reference link : https://www.elastic.co/guide/en/elasticsearch/reference/current/mapping.html
...
# Local Host URL : http://localhost:9200/questions-index
